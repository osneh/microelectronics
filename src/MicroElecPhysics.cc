  ...
  while( (*particleIterator)() )
  {
	...
	G4MicroElecElastic* theMicroElecElasticProcess = new G4MicroElecElastic("e-_G4MicroElecElastic");
     ...
     // Modified for capture in Al2O3 and SiO2 (Polaronic trapping effect)
      ...
      // CI !!!! il faut rajouter sigma Fe, Be, BN, 
      /* modif 
      ...
      */
      ...
      // Capture for alphas 
      G4MicroElecCapture* acap = new G4MicroElecCapture("Target", 100.1 * eV);
      pmanager->AddDiscreteProcess(acap);//*/
      ...
      // Capture for generic ions 
      G4MicroElecCapture* gcap = new G4MicroElecCapture("Target", 100.1 * eV);
      pmanager->AddDiscreteProcess(gcap);//*/
    } 
  }
...
//  G4double hw = 0.15*eV;
 ...
 //Phonons LO pour sio2,  al2o3 and BN
  ...
  //mod = new G4MicroElecLOPhononModel_new(0.153 * eV, false);
