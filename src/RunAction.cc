...
void RunAction::EndWorker(const G4Run* run)
{
  ...
  G4cout << "Number and type of particles created in region \"WORLD (Primary)\" :" << G4endl;
  ...
  G4cout << "_______________________" << G4endl;
  std::map<const G4ParticleDefinition*, int>&
    particlesCreatedOutTarget = fpTrackingAction->GetNParticlesCreatedOutTarget();
  G4cout << "Number and type of particles created outside  region \"Target\" :" << G4endl;
  PrintNParticles(particlesCreatedOutTarget);
  
  G4cout << "_______________________" << G4endl;
//  G4cout << "Number secondries of particles created outside  region \"Target\" :" << G4endl;
