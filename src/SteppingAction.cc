...
if ( ( step->GetPostStepPoint()->GetMomentumDirection().z() < 0. )  && 
  ...
  //G4cout << "  TEST 0 " <<  step->GetTrack()->GetVolume()->GetName() << G4endl;
 // G4cout << "  TEST " << step->GetPostStepPoint()->GetKineticEnergy()/eV << G4endl; 
  //G4cout << "  TESTz" << step->GetPostStepPoint()->GetMomentumDirection().z() << G4endl; 
  //  G4cout << "  TESTx" << step->GetPostStepPoint()->GetMomentumDirection().x() << G4endl; 
  //    G4cout << "  TESTy" << step->GetPostStepPoint()->GetMomentumDirection().y() << G4endl; 
}
